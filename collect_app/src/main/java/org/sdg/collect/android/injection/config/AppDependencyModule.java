...
import org.sdg.collect.android.analytics.FirebaseAnalytics;
import org.sdg.collect.android.backgroundwork.CollectBackgroundWorkManager;
...
import org.sdg.collect.android.formentry.media.AudioHelperFactory;
import org.sdg.collect.android.formentry.media.ScreenContextAudioHelperFactory;
import org.sdg.collect.android.geo.MapProvider;
import org.sdg.collect.android.jobs.CollectJobCreator;
import org.sdg.collect.android.metadata.InstallIDProvider;
import org.sdg.collect.android.metadata.SharedPreferencesInstallIDProvider;
import org.sdg.collect.android.network.ConnectivityProvider;
import org.sdg.collect.android.network.NetworkStateProvider;
import org.sdg.collect.android.openrosa.CollectThenSystemContentTypeMapper;
import org.sdg.collect.android.openrosa.OpenRosaAPIClient;
import org.sdg.collect.android.openrosa.OpenRosaHttpInterface;
import org.sdg.collect.android.openrosa.okhttp.OkHttpConnection;
import org.sdg.collect.android.openrosa.okhttp.OkHttpOpenRosaServerClientProvider;
...
import org.sdg.collect.android.preferences.MetaSharedPreferencesProvider;
import org.sdg.collect.android.preferences.qr.ObservableQRCodeGenerator;
import org.sdg.collect.android.preferences.qr.QRCodeGenerator;
import org.sdg.collect.android.storage.StorageInitializer;
import org.sdg.collect.android.storage.StoragePathProvider;
import org.sdg.collect.android.storage.StorageStateProvider;
import org.sdg.collect.android.storage.migration.StorageEraser;
import org.sdg.collect.android.storage.migration.StorageMigrationRepository;
import org.sdg.collect.android.storage.migration.StorageMigrator;
import org.sdg.collect.android.tasks.sms.SmsSubmissionManager;
import org.sdg.collect.android.tasks.sms.contracts.SmsSubmissionManagerContract;
import org.sdg.collect.android.utilities.ActivityAvailability;
import org.sdg.collect.android.utilities.AdminPasswordProvider;
import org.sdg.collect.android.utilities.AndroidUserAgent;
import org.sdg.collect.android.utilities.DeviceDetailsProvider;
import org.sdg.collect.android.utilities.FormListDownloader;
import org.sdg.collect.android.utilities.PermissionUtils;
import org.sdg.collect.android.utilities.WebCredentialsUtils;
import org.sdg.collect.android.version.VersionInformation;
import org.sdg.collect.utilities.BackgroundWorkManager;
...
import static org.sdg.collect.android.preferences.GeneralKeys.KEY_INSTALL_ID;
