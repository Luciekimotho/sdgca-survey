...
package org.sdg.collect.android.widgets;
...
import org.sdg.collect.android.formentry.questions.QuestionTextSizeHelper;
import org.sdg.collect.android.formentry.media.AudioHelperFactory;
import org.sdg.collect.android.formentry.questions.AudioVideoImageTextLabel;
import org.sdg.collect.android.formentry.questions.QuestionDetails;
...
import org.sdg.collect.android.preferences.GuidanceHint;
import org.sdg.collect.android.utilities.AnimationUtils;
import org.sdg.collect.android.utilities.FormEntryPromptUtils;
import org.sdg.collect.android.utilities.PermissionUtils;
import org.sdg.collect.android.utilities.SoftKeyboardUtils;
import org.sdg.collect.android.utilities.StringUtils;
import org.sdg.collect.android.utilities.ThemeUtils;
import org.sdg.collect.android.utilities.ViewUtils;
import org.sdg.collect.android.widgets.interfaces.Widget;
...
import static org.sdg.collect.android.analytics.AnalyticsEvents.AUDIO_QUESTION;
import static org.sdg.collect.android.formentry.media.FormMediaUtils.getClipID;
import static org.sdg.collect.android.formentry.media.FormMediaUtils.getPlayColor;
import static org.sdg.collect.android.formentry.media.FormMediaUtils.getPlayableAudioURI;
import static org.sdg.collect.android.injection.DaggerUtils.getComponent;
