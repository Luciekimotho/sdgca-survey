...
package org.sdg.collect.android.activities;
...
import org.sdg.collect.android.audio.AudioControllerView;
import org.sdg.collect.android.dao.FormsDao;
import org.sdg.collect.android.dao.helpers.ContentResolverHelper;
import org.sdg.collect.android.dao.helpers.FormsDaoHelper;
import org.sdg.collect.android.dao.helpers.InstancesDaoHelper;
import org.sdg.collect.android.events.ReadPhoneStatePermissionRxEvent;
import org.sdg.collect.android.events.RxEventBus;
import org.sdg.collect.android.exception.JavaRosaException;
import org.sdg.collect.android.external.ExternalDataManager;
import org.sdg.collect.android.formentry.FormEntryMenuDelegate;
import org.sdg.collect.android.formentry.FormEntryViewModel;
import org.sdg.collect.android.formentry.FormIndexAnimationHandler;
import org.sdg.collect.android.formentry.FormLoadingDialogFragment;
import org.sdg.collect.android.formentry.ODKView;
import org.sdg.collect.android.formentry.QuitFormDialog;
import org.sdg.collect.android.formentry.audit.AuditEvent;
import org.sdg.collect.android.formentry.audit.AuditUtils;
import org.sdg.collect.android.formentry.audit.ChangesReasonPromptDialogFragment;
import org.sdg.collect.android.formentry.audit.IdentifyUserPromptDialogFragment;
import org.sdg.collect.android.formentry.audit.IdentityPromptViewModel;
import org.sdg.collect.android.formentry.backgroundlocation.BackgroundLocationManager;
import org.sdg.collect.android.formentry.backgroundlocation.BackgroundLocationViewModel;
import org.sdg.collect.android.formentry.loading.FormInstanceFileCreator;
import org.sdg.collect.android.formentry.repeats.AddRepeatDialog;
import org.sdg.collect.android.formentry.saving.FormSaveViewModel;
import org.sdg.collect.android.formentry.saving.SaveFormProgressDialogFragment;
import org.sdg.collect.android.fragments.MediaLoadingFragment;
import org.sdg.collect.android.fragments.dialogs.CustomDatePickerDialog;
import org.sdg.collect.android.fragments.dialogs.LocationProvidersDisabledDialog;
import org.sdg.collect.android.fragments.dialogs.NumberPickerDialog;
import org.sdg.collect.android.fragments.dialogs.ProgressDialogFragment;
import org.sdg.collect.android.fragments.dialogs.RankingWidgetDialog;
import org.sdg.collect.android.javarosawrapper.FormController;
import org.sdg.collect.android.javarosawrapper.FormController.FailedConstraint;
import org.sdg.collect.android.listeners.AdvanceToNextListener;
import org.sdg.collect.android.listeners.FormLoaderListener;
import org.sdg.collect.android.listeners.PermissionListener;
import org.sdg.collect.android.listeners.SavePointListener;
import org.sdg.collect.android.listeners.WidgetValueChangedListener;
import org.sdg.collect.android.logic.FormInfo;
import org.sdg.collect.android.logic.ImmutableDisplayableQuestion;
import org.sdg.collect.android.network.NetworkStateProvider;
import org.sdg.collect.android.preferences.AdminKeys;
import org.sdg.collect.android.preferences.AdminSharedPreferences;
import org.sdg.collect.android.preferences.GeneralKeys;
import org.sdg.collect.android.preferences.GeneralSharedPreferences;
import org.sdg.collect.android.provider.FormsProviderAPI.FormsColumns;
import org.sdg.collect.android.provider.InstanceProviderAPI.InstanceColumns;
import org.sdg.collect.android.storage.StorageInitializer;
import org.sdg.collect.android.storage.StoragePathProvider;
import org.sdg.collect.android.storage.StorageSubdirectory;
import org.sdg.collect.android.tasks.FormLoaderTask;
import org.sdg.collect.android.tasks.SaveFormIndexTask;
import org.sdg.collect.android.tasks.SaveFormToDisk;
import org.sdg.collect.android.tasks.SavePointTask;
import org.sdg.collect.android.upload.AutoSendWorker;
import org.sdg.collect.android.utilities.ApplicationConstants;
import org.sdg.collect.android.utilities.DestroyableLifecyleOwner;
import org.sdg.collect.android.utilities.DialogUtils;
import org.sdg.collect.android.utilities.FileUtils;
import org.sdg.collect.android.utilities.FormNameUtils;
import org.sdg.collect.android.utilities.ImageConverter;
import org.sdg.collect.android.utilities.MediaManager;
import org.sdg.collect.android.utilities.MediaUtils;
import org.sdg.collect.android.utilities.PermissionUtils;
import org.sdg.collect.android.utilities.PlayServicesUtil;
import org.sdg.collect.android.utilities.QuestionFontSizeUtils;
import org.sdg.collect.android.utilities.ScreenContext;
import org.sdg.collect.android.utilities.SnackbarUtils;
import org.sdg.collect.android.utilities.SoftKeyboardUtils;
import org.sdg.collect.android.utilities.ToastUtils;
import org.sdg.collect.android.widgets.DateTimeWidget;
import org.sdg.collect.android.widgets.QuestionWidget;
import org.sdg.collect.android.widgets.RangeWidget;
...
import static org.sdg.collect.android.analytics.AnalyticsEvents.LAUNCH_FORM_WITH_BG_LOCATION;
import static org.sdg.collect.android.analytics.AnalyticsEvents.SAVE_INCOMPLETE;
import static org.sdg.collect.android.fragments.BarcodeWidgetScannerFragment.BARCODE_RESULT_KEY;
import static org.sdg.collect.android.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.sdg.collect.android.utilities.AnimationUtils.areAnimationsEnabled;
import static org.sdg.collect.android.utilities.ApplicationConstants.RequestCodes;
import static org.sdg.collect.android.utilities.DialogUtils.getDialog;
import static org.sdg.collect.android.utilities.DialogUtils.showIfNotShowing;
import static org.sdg.collect.android.utilities.PermissionUtils.areStoragePermissionsGranted;
import static org.sdg.collect.android.utilities.PermissionUtils.finishAllActivities;
import static org.sdg.collect.android.utilities.ToastUtils.showLongToast;
import static org.sdg.collect.android.utilities.ToastUtils.showShortToast;
