...
import org.sdg.collect.android.activities.CaptureSelfieVideoActivity;
import org.sdg.collect.android.application.Collect;
import org.sdg.collect.android.formentry.questions.QuestionDetails;
import org.sdg.collect.android.formentry.questions.WidgetViewUtils;
import org.sdg.collect.android.listeners.PermissionListener;
import org.sdg.collect.android.preferences.GeneralKeys;
import org.sdg.collect.android.utilities.CameraUtils;
import org.sdg.collect.android.utilities.FileUtil;
import org.sdg.collect.android.utilities.FileUtils;
import org.sdg.collect.android.utilities.MediaManager;
import org.sdg.collect.android.utilities.MediaUtil;
import org.sdg.collect.android.utilities.ToastUtils;
import org.sdg.collect.android.utilities.WidgetAppearanceUtils;
import org.sdg.collect.android.widgets.interfaces.FileWidget;
import org.sdg.collect.android.widgets.utilities.FileWidgetUtils;
...
import static org.sdg.collect.android.analytics.AnalyticsEvents.REQUEST_HIGH_RES_VIDEO;
import static org.sdg.collect.android.analytics.AnalyticsEvents.REQUEST_VIDEO_NOT_HIGH_RES;
import static org.sdg.collect.android.formentry.questions.WidgetViewUtils.createSimpleButton;
...
public class VideoWidget extends QuestionWidget implements FileWidget {
     ...
     * @see org.sdg.collect.android.activities.FormEntryActivity#onActivityResult(int, int, Intent)
     */
    @Override
