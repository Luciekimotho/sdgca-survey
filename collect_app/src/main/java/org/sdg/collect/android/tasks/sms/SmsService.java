package org.sdg.collect.android.tasks.sms;
...
import org.sdg.collect.android.events.SmsRxEvent;
import org.sdg.collect.android.jobs.SmsSenderJob;
...
import org.sdg.collect.android.tasks.sms.models.Message;
import org.sdg.collect.android.tasks.sms.models.SmsProgress;
import org.sdg.collect.android.tasks.sms.models.SmsSubmission;
import org.sdg.collect.android.upload.InstanceServerUploader;
import org.sdg.collect.android.utilities.ArrayUtils;
...
import static org.sdg.collect.android.tasks.sms.SmsSender.SMS_INSTANCE_ID;
import static org.sdg.collect.android.tasks.sms.SmsSender.SMS_MESSAGE_ID;
import static org.sdg.collect.android.tasks.sms.SmsSender.SMS_RESULT_CODE;
import static org.sdg.collect.android.tasks.sms.SmsSender.checkIfSentIntentExists;
import static org.sdg.collect.android.utilities.FileUtil.getFileContents;
import static org.sdg.collect.android.utilities.FileUtil.getSmsInstancePath;
