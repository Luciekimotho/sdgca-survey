...
package org.sdgtest.collect.android.activities;
...
import org.sdgtest.collect.android.dao.FormsDao;
import org.sdgtest.collect.android.dao.helpers.ContentResolverHelper;
import org.sdgtest.collect.android.dao.helpers.FormsDaoHelper;
import org.sdgtest.collect.android.dao.helpers.InstancesDaoHelper;
import org.sdgtest.collect.android.events.ReadPhoneStatePermissionRxEvent;
import org.sdgtest.collect.android.events.RxEventBus;
import org.sdgtest.collect.android.exception.JavaRosaException;
import org.sdgtest.collect.android.external.ExternalDataManager;
import org.sdgtest.collect.android.formentry.FormEntryMenuDelegate;
import org.sdgtest.collect.android.formentry.FormEntryViewModel;
import org.sdgtest.collect.android.formentry.FormIndexAnimationHandler;
import org.sdgtest.collect.android.formentry.FormLoadingDialogFragment;
import org.sdgtest.collect.android.formentry.ODKView;
import org.sdgtest.collect.android.formentry.QuitFormDialog;
import org.sdgtest.collect.android.formentry.audit.AuditEvent;
import org.sdgtest.collect.android.formentry.audit.AuditUtils;
import org.sdgtest.collect.android.formentry.audit.ChangesReasonPromptDialogFragment;
import org.sdgtest.collect.android.formentry.audit.IdentifyUserPromptDialogFragment;
import org.sdgtest.collect.android.formentry.audit.IdentityPromptViewModel;
import org.sdgtest.collect.android.formentry.backgroundlocation.BackgroundLocationManager;
import org.sdgtest.collect.android.formentry.backgroundlocation.BackgroundLocationViewModel;
import org.sdgtest.collect.android.formentry.loading.FormInstanceFileCreator;
import org.sdgtest.collect.android.formentry.repeats.AddRepeatDialog;
import org.sdgtest.collect.android.formentry.saving.FormSaveViewModel;
import org.sdgtest.collect.android.formentry.saving.SaveFormProgressDialogFragment;
import org.sdgtest.collect.android.fragments.MediaLoadingFragment;
import org.sdgtest.collect.android.fragments.dialogs.CustomDatePickerDialog;
import org.sdgtest.collect.android.fragments.dialogs.LocationProvidersDisabledDialog;
import org.sdgtest.collect.android.fragments.dialogs.NumberPickerDialog;
import org.sdgtest.collect.android.fragments.dialogs.ProgressDialogFragment;
import org.sdgtest.collect.android.fragments.dialogs.RankingWidgetDialog;
import org.sdgtest.collect.android.javarosawrapper.FormController;
import org.sdgtest.collect.android.javarosawrapper.FormController.FailedConstraint;
import org.sdgtest.collect.android.listeners.AdvanceToNextListener;
import org.sdgtest.collect.android.listeners.FormLoaderListener;
import org.sdgtest.collect.android.listeners.PermissionListener;
import org.sdgtest.collect.android.listeners.SavePointListener;
import org.sdgtest.collect.android.listeners.WidgetValueChangedListener;
import org.sdgtest.collect.android.logic.FormInfo;
import org.sdgtest.collect.android.logic.ImmutableDisplayableQuestion;
import org.sdgtest.collect.android.network.NetworkStateProvider;
import org.sdgtest.collect.android.preferences.AdminKeys;
import org.sdgtest.collect.android.preferences.AdminSharedPreferences;
import org.sdgtest.collect.android.preferences.GeneralKeys;
import org.sdgtest.collect.android.preferences.GeneralSharedPreferences;
import org.sdgtest.collect.android.provider.FormsProviderAPI.FormsColumns;
import org.sdgtest.collect.android.provider.InstanceProviderAPI.InstanceColumns;
...
import org.sdgtest.collect.android.tasks.FormLoaderTask;
import org.sdgtest.collect.android.tasks.SaveFormIndexTask;
import org.sdgtest.collect.android.tasks.SaveFormToDisk;
import org.sdgtest.collect.android.tasks.SavePointTask;
import org.sdgtest.collect.android.upload.AutoSendWorker;
import org.sdgtest.collect.android.utilities.ApplicationConstants;
import org.sdgtest.collect.android.utilities.DestroyableLifecyleOwner;
import org.sdgtest.collect.android.utilities.DialogUtils;
import org.sdgtest.collect.android.utilities.FileUtils;
import org.sdgtest.collect.android.utilities.FormNameUtils;
import org.sdgtest.collect.android.utilities.ImageConverter;
import org.sdgtest.collect.android.utilities.MediaManager;
import org.sdgtest.collect.android.utilities.MediaUtils;
import org.sdgtest.collect.android.utilities.PermissionUtils;
import org.sdgtest.collect.android.utilities.PlayServicesUtil;
import org.sdgtest.collect.android.utilities.QuestionFontSizeUtils;
import org.sdgtest.collect.android.utilities.ScreenContext;
import org.sdgtest.collect.android.utilities.SnackbarUtils;
import org.sdgtest.collect.android.utilities.SoftKeyboardUtils;
import org.sdgtest.collect.android.utilities.ToastUtils;
import org.sdgtest.collect.android.widgets.DateTimeWidget;
import org.sdgtest.collect.android.widgets.QuestionWidget;
import org.sdgtest.collect.android.widgets.RangeWidget;
...
import static org.sdgtest.collect.android.analytics.AnalyticsEvents.LAUNCH_FORM_WITH_BG_LOCATION;
import static org.sdgtest.collect.android.analytics.AnalyticsEvents.SAVE_INCOMPLETE;
import static org.sdgtest.collect.android.fragments.BarcodeWidgetScannerFragment.BARCODE_RESULT_KEY;
import static org.sdgtest.collect.android.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.sdgtest.collect.android.utilities.AnimationUtils.areAnimationsEnabled;
import static org.sdgtest.collect.android.utilities.ApplicationConstants.RequestCodes;
import static org.sdgtest.collect.android.utilities.DialogUtils.getDialog;
import static org.sdgtest.collect.android.utilities.DialogUtils.showIfNotShowing;
import static org.sdgtest.collect.android.utilities.PermissionUtils.areStoragePermissionsGranted;
import static org.sdgtest.collect.android.utilities.PermissionUtils.finishAllActivities;
import static org.sdgtest.collect.android.utilities.ToastUtils.showLongToast;
import static org.sdgtest.collect.android.utilities.ToastUtils.showShortToast;
