...
import org.sdgtest.collect.android.analytics.FirebaseAnalytics;
import org.sdgtest.collect.android.backgroundwork.CollectBackgroundWorkManager;
import org.sdgtest.collect.android.dao.FormsDao;
import org.sdgtest.collect.android.dao.InstancesDao;
import org.sdgtest.collect.android.events.RxEventBus;
import org.sdgtest.collect.android.formentry.media.AudioHelperFactory;
import org.sdgtest.collect.android.formentry.media.ScreenContextAudioHelperFactory;
import org.sdgtest.collect.android.geo.MapProvider;
import org.sdgtest.collect.android.jobs.CollectJobCreator;
import org.sdgtest.collect.android.metadata.InstallIDProvider;
import org.sdgtest.collect.android.metadata.SharedPreferencesInstallIDProvider;
import org.sdgtest.collect.android.network.ConnectivityProvider;
import org.sdgtest.collect.android.network.NetworkStateProvider;
import org.sdgtest.collect.android.openrosa.CollectThenSystemContentTypeMapper;
import org.sdgtest.collect.android.openrosa.OpenRosaAPIClient;
...
import org.sdgtest.collect.android.preferences.MetaSharedPreferencesProvider;
import org.sdgtest.collect.android.preferences.qr.ObservableQRCodeGenerator;
import org.sdgtest.collect.android.preferences.qr.QRCodeGenerator;
...
import org.sdgtest.collect.android.storage.StorageStateProvider;
import org.sdgtest.collect.android.storage.migration.StorageEraser;
import org.sdgtest.collect.android.storage.migration.StorageMigrationRepository;
import org.sdgtest.collect.android.storage.migration.StorageMigrator;
import org.sdgtest.collect.android.tasks.sms.SmsSubmissionManager;
import org.sdgtest.collect.android.tasks.sms.contracts.SmsSubmissionManagerContract;
import org.sdgtest.collect.android.utilities.ActivityAvailability;
import org.sdgtest.collect.android.utilities.AdminPasswordProvider;
import org.sdgtest.collect.android.utilities.AndroidUserAgent;
import org.sdgtest.collect.android.utilities.DeviceDetailsProvider;
import org.sdgtest.collect.android.utilities.FormListDownloader;
import org.sdgtest.collect.android.utilities.PermissionUtils;
import org.sdgtest.collect.android.utilities.WebCredentialsUtils;
import org.sdgtest.collect.android.version.VersionInformation;
import org.sdgtest.collect.utilities.BackgroundWorkManager;
...
import static org.sdgtest.collect.android.preferences.GeneralKeys.KEY_INSTALL_ID;
