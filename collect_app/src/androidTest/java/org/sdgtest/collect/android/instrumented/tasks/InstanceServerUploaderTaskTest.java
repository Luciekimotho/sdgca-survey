package org.sdgtest.collect.android.instrumented.tasks;
...
import org.sdgtest.collect.android.openrosa.OpenRosaConstants;
...
import org.sdgtest.collect.android.tasks.InstanceUploaderTask;
import org.sdgtest.collect.android.support.MockedServerTest;
...
import static org.sdgtest.collect.android.support.TestUtils.assertMatches;
import static org.sdgtest.collect.android.support.TestUtils.cleanUpTempFiles;
import static org.sdgtest.collect.android.support.TestUtils.createTempFile;
import static org.sdgtest.collect.android.support.TestUtils.resetInstancesContentProvider;
...
public class InstanceServerUploaderTaskTest extends MockedServerTest {
    ...
    public void shouldUploadAnInstance() throws Exception {
        ...
        HEAD: {
            ...
            assertMatches("org.sdgtest.collect.android/.* Dalvik/.*", r.getHeader("User-Agent"));
