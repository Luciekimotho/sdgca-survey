package org.sdg.collect.android.instrumented.tasks;
...
import org.sdg.collect.android.openrosa.OpenRosaConstants;
...
import org.sdg.collect.android.tasks.InstanceUploaderTask;
import org.sdg.collect.android.support.MockedServerTest;
...
import static org.sdg.collect.android.support.TestUtils.assertMatches;
import static org.sdg.collect.android.support.TestUtils.cleanUpTempFiles;
import static org.sdg.collect.android.support.TestUtils.createTempFile;
import static org.sdg.collect.android.support.TestUtils.resetInstancesContentProvider;
...
public class InstanceServerUploaderTaskTest extends MockedServerTest {
    ...
    public void shouldUploadAnInstance() throws Exception {
        ...
        HEAD: {
            ...
            assertMatches("org.sdg.collect.android/.* Dalvik/.*", r.getHeader("User-Agent"));
